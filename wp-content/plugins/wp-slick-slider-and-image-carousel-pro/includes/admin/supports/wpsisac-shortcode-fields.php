			...
			'general' => array(
					...
					'params'   	=>  array(
									...
									array(
										...
										'desc' 		=> __( 'Display read more button.', 'wp-slick-slider-and-image-carousel' )
									),
									array(
										'type' 			=> 'text',
									...
									array(
										...
										'name' 		=> 'sliderheight',
										'value' 	=> '',
										'desc' 		=> __( 'Enter slider image height. Leave empty for default height.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type'		=> 'dropdown',
										...
										'desc' 		=> __( 'Set image fit.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type'		=> 'text',
			...
			'slider' => array(
					...
					'params'    => array(
									...
									array(
										...
										'desc' 		=> __( 'Enable loop.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type' 		=> 'number',
			...
			'query' => array(
					...
					'params'    => array(
									...
									array(
										...
										'name' 		=> 'query_offset',
										'value' 	=> '',
										'desc' 		=> __( 'Exclude number of posts from starting.', 'wp-slick-slider-and-image-carousel' ) . '<label title="'.__('e.g if you pass 5 then it will skip first five post. Note: Do not use limit=-1 and pagination=true with this.', 'wp-slick-slider-and-image-carousel').'"> [?]</label>',
									),
								)
			),
	);
			...
			'general' => array(
					...
					'params'    =>  array(
									...
									array(
										...
										'desc' 		=> __( 'Display read more btn.', 'wp-slick-slider-and-image-carousel' )
									),
									array(
										'type' 			=> 'text',
										'heading' 		=> __( 'Read More Text', 'wp-slick-slider-and-image-carousel' ),
									...
									array(
										...
										'name' 		=> 'sliderheight',
										'value' 	=> '',
										'desc' 		=> __( 'Enter slider image height.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type' 		=> 'dropdown',
										'heading' 	=> __( 'Image Fit', 'wp-slick-slider-and-image-carousel' ),
			...
			'slider' => array(
					...
					'params'    => array(
									...
									array(
										...
										'name' 		=> 'slidestoshow',
										'value' 	=> 3,
										'desc' 		=> __( 'Enter slide to show.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type' 		=> 'number',
										...
										'name' 		=> 'slidestoscroll',
										'value' 	=> 1,
										'desc' 		=> __( 'Enter slide to scroll.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type' 		=> 'dropdown',
										'heading' 	=> __( 'Autoplay', 'wp-slick-slider-and-image-carousel' ),
									...
									array(
										...
										'default'	=> 'false',
										'desc' 		=> __( 'Enable centermode.', 'wp-slick-slider-and-image-carousel' ),
									),
									array(
										'type' 		=> 'number',
