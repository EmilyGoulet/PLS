										...
										<tbody>
											...
											<tr>
												...
												<td>
													...
													<br/><br/>
													<div><a class="button button-primary wpsisac-shrt-map-btn" href="<?php echo esc_url( $shrt_mapper ); ?>"><?php _e('Try Our Shortcode Generator!!', 'wp-slick-slider-and-image-carousel'); ?></a></div>
												</td>
											</tr>
										</tbody>
									</table>
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox" style="">
								...
								<div class="inside">
									...
									<a class="button button-primary wpos-button-full" href="http://docs.wponlinesupport.com/wp-slick-slider-and-image-carousel-pro/?utm_source=hp&event=doc" target="_blank"><?php _e('Documentation', 'wp-slick-slider-and-image-carousel'); ?></a>
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/pro-wp-slick-slider-and-carousel-demo/?utm_source=hp&event=pro_demo" target="_blank"><?php _e('Demo for Designs', 'wp-slick-slider-and-image-carousel'); ?></a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
						...
						<div class="meta-box-sortables ui-sortable">
							<div class="postbox">
								...
								<div class="inside">
									...
									<p><a class="button button-primary wpos-button-full" href="https://www.wponlinesupport.com/wordpress-support/?utm_source=hp&event=projobs" target="_blank"><?php _e('Know More', 'wp-slick-slider-and-image-carousel'); ?></a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
						</div><!-- .meta-box-sortables ui-sortable -->
					</div><!-- .metabox-holder -->
