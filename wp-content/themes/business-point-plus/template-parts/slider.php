...
<?php echo do_shortcode('[slick-variable-slider design="prodesign-6" sliderheight="300" extra_class="background"]'); ?>
<!-- <?php echo do_shortcode('[slick-carousel-slider design="prodesign-6" extra_class="background"]'); ?> 
 -->
 <?php
/**
 * Helper functions.
