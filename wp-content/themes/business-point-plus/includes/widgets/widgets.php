...
if ( ! function_exists( 'business_point_load_widgets' ) ) :
	...
	function business_point_load_widgets() {
		...
		// Fun Facts widget
		register_widget( 'Business_Point_Fun_Facts_Widget' );
 ...
 * Fun Facts Widget
 */
require get_template_directory() . '/includes/widgets/fun-facts.php';

//Add widget if woocommerce is active
if( class_exists( 'WooCommerce' ) ){

	if ( ! function_exists( 'business_point_load_woocommerce_widgets' ) ) :
		 ...
		 * @since 1.0.0
		 */
		function business_point_load_woocommerce_widgets() {

			// Latest Products widget
			register_widget( 'Business_Point_Latest_Product_Widget' );

			// Featured Products widget
			register_widget( 'Business_Point_Featured_Product_Widget' );

		}

	endif;

	add_action( 'widgets_init', 'business_point_load_woocommerce_widgets' );
	 ...
	 * Featured Products Widget
	 */
	require get_template_directory() . '/includes/widgets/featured-products.php';
...
<!-- added the #2 to the end of "inner-wrapper" class below to diffentiate between this one and the one used in the testimonials section -->
