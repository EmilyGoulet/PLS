                    ...
                    if( 'top-menu' == $right_section && has_nav_menu( 'top' ) ){ ?>
                        <div class="top-menu-content">
                            ...
                            wp_nav_menu(
                                ...
                                'menu_id'        => 'top-menu',
                                'depth'          => 1,    
                                'fallback_cb'    => 'business_point_top_navigation_fallback',                               
                                )
                            ); ?>
                        </div><!-- .menu-content -->
                        <?php
...
<!-- 				<div> -->
<!-- 				<p> -->
<!-- 					<a class="button-one" title="Relevant Title" href="#">Get Started</a><a class="button-two" title="Relevant Title" href="#">Contact Us</a> -->
<!-- 				</p> -->
<!-- 			</div> -->
            </div> <!-- #main-nav -->
        </div>
...
if ( ! function_exists( 'business_point_credit_info' ) ) :
    ...
    function business_point_credit_info(){ 
        ...
        $powerby_text = business_point_get_option( 'powerby_text' );
